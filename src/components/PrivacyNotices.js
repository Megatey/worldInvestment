      ...
      <h1>Privacy notices</h1>
        ...
        <div className="about-us-div-header-img privacy-img">
          <span className="about-us-div-header-img-txt display-none-reverse">
            <h1>Privacy Notices</h1>Please do not hesitate to contact us if you have
            any questions or concerns related to the processing of your personal
            data – contact details are provided in the relevant Privacy Notice
            below.
          </span>
        </div>
        <div className="text-note display-none"> <h1>Privacy Notices</h1>Please do not hesitate to contact us if you have
            any questions or concerns related to the processing of your personal
            data – contact details are provided in the relevant Privacy Notice
            below.</div>
        <div className="text-note">
          ...
          <h1> Your Rights: </h1>You have certain rights regarding your personal
          information, including the right to access, correct, or delete your
          data. If you wish to exercise these rights or have any questions or
          concerns about our privacy practices, please contact us using the
          information provided at the end of this notice.
          <h1> Data Retention: </h1>We will retain your personal information for
          ...
          update or modify this Privacy Notice at any time without prior notice.
          Any changes will be effective immediately upon posting the revised
          notice on our website. We encourage you to review this notice
          ...
          <span className="privacy-span">
            ...
            <span>NNPC Bonny Export Terminal Office, Bonny, Rivers State Nigeria.</span>
